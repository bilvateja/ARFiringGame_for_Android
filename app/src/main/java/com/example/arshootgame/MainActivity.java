package com.example.arshootgame;
...
public class MainActivity extends AppCompatActivity {
    ...
    private ModelRenderable bulletRendarable;
    private boolean timestarted = false;
    private int fireLeft = 3;
    ...
    private void shoot() {
        ...
        Node node = new Node();
        node.setRenderable(bulletRendarable);
        scene.addChild(node);
    ...
    private void builtBullet() {
        Texture.builder()
                .setSource(this,R.drawable.capture)
                .build()
                .thenAccept(texture -> {
                    MaterialFactory.makeOpaqueWithTexture(this,texture)
                            .thenAccept(material -> {
                                bulletRendarable = ShapeFactory.makeSphere(0.02f,new Vector3(0f,0f,0f),material);
                            });
                });
    }
